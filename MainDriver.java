...
import dmlab.pamae.Algorithms;
import dmlab.pamae.DoublePoint;
import dmlab.pamae.PAMAE;
import scala.Tuple2;
/**
...
public class MainDriver {
	...
	public static void main(String[] args) throws IOException
	{
		...
		JavaRDD<DoublePoint> dataSet = PAMAE.readFile(sc, inputPath, numOfCores);
		
	    //Phase I (STEP 1 ~ STEP 3) : Parallel Seeding
	   	List<DoublePoint> bestSeed = PAMAE.PHASE_I(sc, dataSet, numOfClusters, numOfSampledObjects, numOfSamples, numOfCores);
		
	    //Phase II (STEP 4 ~ STEP 5) : Parallel Refinement
		List<DoublePoint> finalMedoids = PAMAE.PHASE_II(sc, dataSet, bestSeed, numOfClusters, numOfSampledObjects, numOfSamples, numOfCores);

...
public class MainDriver {
	...
	private static void summary()
	{
		...
		System.out.println("[5]final cost");
	...
	private static Job setJob(Configuration conf, FileSystem fs) throws IOException
	{
		...
		try {
			...
			topOffJob.setMapperClass(PamMapper.class);
			topOffJob.setReducerClass(PamReducer.class);
	...
	/**
	 * Immediate Intermediate file processing
	 * @throws IOException 
	 */

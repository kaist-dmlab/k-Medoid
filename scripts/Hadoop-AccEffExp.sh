...
do
	...
	do
		...
		do
			...
			hadoop jar PAM-MR.jar dmlab.main.MainDriver /dataset/$dataset /output $k > PAM-MR/$dataset/$k/$i
			echo "hadoop jar FAMES-MR.jar dmlab.main.MainDriver /dataset/$dataset /output $k > FAMES-MR/$dataset/$k/$i"
			hadoop jar FAMES-MR.jar dmlab.main.MainDriver /dataset/$dataset /output $k > FAMES-MR/$dataset/$k/$i
			echo "hadoop jar CLARA-MR.jar dmlab.main.MainDriver /dataset/$dataset /output 5 $k 0 > CLARA-MR-PRIME/$dataset/$k/$i"
			hadoop jar CLARA-MR.jar dmlab.main.MainDriver /dataset/$dataset /output 5 $k 0 > CLARA-MR-PRIME/$dataset/$k/$i
			echo "hadoop jar CLARA-MR.jar dmlab.main.MainDriver /dataset/$dataset /output 5 $k 0 > CLARA-MR/$dataset/$k/$i"
			hadoop jar CLARA-MR.jar dmlab.main.MainDriver /dataset/$dataset /output 5 $k 0 > CLARA-MR/$dataset/$k/$i
			echo "hadoop jar GREEDI.jar dmlab.main.MainDriver /dataset/$dataset /output $k $k > GREEDI/$dataset/$k/$i"
			hadoop jar GREEDI.jar dmlab.main.MainDriver /dataset/$dataset /output $k $k > GREEDI/$dataset/$k/$i
			echo "hadoop jar ITERATIVE-SAMPLING.jar dmlab.main.MainDriver /dataset/$dataset output $k 0.1 40 $size > iterative_sample.csv"
			hadoop jar ITERATIVE-SAMPLING.jar dmlab.main.MainDriver /dataset/$dataset output $k 0.1 40 $size > iterative_sample.csv
			echo "hadoop dfs -rm /dataset/iterative_sample.csv"
			hadoop dfs -rm /dataset/iterative_sample.csv
			...
			hadoop jar WEIGHTED_KMEDIAN.jar dmlab.main.MainDriver /dataset/$dataset /dataset/iterative_sample.csv output $k 40 > MR-KMEDIAN/$dataset/$k/$i
			echo "hadoop jar PAMAE-Hadoop.jar  dmlab.main.MainDriver /dataset/$dataset /output $(($k * 40)) 5 $k 40 > PAMAE-Hadoop/$dataset/$k/$i"
			hadoop jar PAMAE-Hadoop.jar  dmlab.main.MainDriver /dataset/$dataset /output $(($k * 40)) 5 $k 40 > PAMAE-Hadoop/$dataset/$k/$i
		done
	done
done
